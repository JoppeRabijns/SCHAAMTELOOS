  ...
  const result = await client.addJob({
    ...
    assets: [
      ...
      },
      {
        ...
        composition: `ALL->PANCARTE->${compNumber}_FOTOS->FOTO`,
      },
      {
        type: "image",
        layerName: "FOTO",
        src: `${data.images.images[1]}`,
        composition: `ALL->PANCARTE->${compNumber}_FOTOS->FOTO_2`,
      },
      {
        type: "image",
        layerName: "FOTO",
        src: `${data.images.images[2]}`,
        composition: `ALL->PANCARTE->${compNumber}_FOTOS->FOTO_3`,
      },
      {
        type: "image",
        layerName: "FOTO",
        src: `${data.images.images[3]}`,
        composition: `ALL->PANCARTE->${compNumber}_FOTOS->FOTO_4`,
      },
      {
        type: "image",
        layerName: "FOTO",
        src: `${data.images.images[4]}`,
        composition: `ALL->PANCARTE->${compNumber}_FOTOS->FOTO_5`,
      },
      {
        type: "data",
